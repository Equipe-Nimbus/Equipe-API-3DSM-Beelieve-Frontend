...
function CardProjeto({ titulo, descricao, estadoProjeto }) {
  ...
  return (
    <>
      <div className="mt-5 flex w-64 cursor-pointer flex-col rounded-md border border-n90 px-5 pt-7 drop-shadow-md duration-100 hover:border-l-8 hover:border-complementary-20">
