  ...
  return (
    <>
      ...
      >
        ...
        <span className="h-8 text-sm font-semibold text-n40 truncate">Responsável: </span><span className="text-sm truncate" >{liderProjeto ? liderProjeto : "Não atribuído"}</span>
        {projetoIniciado ?
